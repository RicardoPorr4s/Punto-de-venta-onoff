...
public class VentanaVenta1 extends javax.swing.JFrame {
    ...
    public void mostrarTabla() {
        ...
        {
            "id", "Empleado", "Nombre producto", "Cantidad", "Total venta", "Fecha", "Forma de pago"
        });
        ...
        try
        {
            while (rs.next())
            {
                ...
                {
                    rs.getString("id_venta"),rs.getString("nombre_empleado"), rs.getString("nombre_producto"), rs.getInt("cantidad"), rs.getFloat("precio"), rs.getDate("fecha"), rs.getString("forma_pago")
                });
