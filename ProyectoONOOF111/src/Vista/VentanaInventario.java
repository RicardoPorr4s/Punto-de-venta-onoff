...
public class VentanaInventario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bRegistrar.setBackground(new java.awt.Color(51, 51, 51));
        ...
        bActualizar1.setBackground(new java.awt.Color(51, 51, 51));
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addComponent(cPrecio, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE)
                                        .addComponent(cExistencia1, javax.swing.GroupLayout.Alignment.LEADING))))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void bActualizar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bActualizar1ActionPerformed
        ...
        if (option == JOptionPane.YES_OPTION)
        {
            try
            {
                ...
                ps = conexion.prepareStatement("update inventario set nombre_producto=?,descripcion=?,cantidad_existencia=?,precio_unidad=? where id_producto=?");
    ...
    private void bRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bRegistrarActionPerformed
        ...
        if (option == JOptionPane.YES_OPTION)
        {
            ...
            try
            {
                ...
                ps = conexion.prepareStatement("insert into inventario(nombre_producto,descripcion,cantidad_existencia,precio_unidad)values(?,?,?,?)");
                ps.setString(1, cNombreProducto.getText());
                ps.setString(2, cDescripcion.getText());
                ps.setString(3, cExistencia1.getText());
                ps.setString(4, cPrecio.getText());

                if ((!"".equals(cNombreProducto.getText()) && !"".equals(cDescripcion.getText())))
                {
    ...
    private void bEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bEliminarActionPerformed
        ...
        if (option == JOptionPane.YES_OPTION)
        {
            ...
            {
                Connection conexion = Conexion.getConexion();
                ps = conexion.prepareStatement("delete from inventario where id_producto=?");
